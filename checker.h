...
void				split_to_b(t_args **stack_a, t_args **stack_b,
					int pos, int *check);
int					get_average(t_args *stack_ab);
int					get_loc_arg(t_args *stack_a, int arg);
void				rot_to_top(t_args **stack_a, t_args **stack_b,
					int loc, int which_way);
void				bigger_sort(t_args **stack_a, t_args **stack_b,
					int chunk_size, int *sorted_arr);
...
void				init_stack_a(t_args **stack_a, int num_args,
					char *argv[], int i);
...
int					get_value_after_last(t_args *stack_ab, int *sorted_arr,
					int num_args);
